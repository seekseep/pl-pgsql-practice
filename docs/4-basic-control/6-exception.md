...
**ファイル:** `sql/5-exception/1-basic-exception.sql`
...
**ファイル:** `sql/5-exception/2-multiple-exceptions.sql`
...
## 3. SQLSTATE と SQLERRM

**ファイル:** `sql/5-exception/3-sqlstate-sqlerrm.sql`
...
## 4. RAISE EXCEPTION (カスタムエラー)

**ファイル:** `sql/5-exception/4-raise-exception.sql`
...
**ファイル:** `sql/5-exception/5-raise-levels.sql`
...
**ファイル:** `sql/5-exception/6-subblock.sql`
...
## 7. UNIQUE 制約違反のハンドリング

**ファイル:** `sql/5-exception/7-unique-violation.sql`
...
**ファイル:** `sql/5-exception/8-fk-violation.sql`
...
## 9. GET STACKED DIAGNOSTICS

**ファイル:** `sql/5-exception/9-get-diagnostics.sql`
...
← [前へ: カーソル](5-cursor.md) | [BASIC_CONTROL](README.md)
