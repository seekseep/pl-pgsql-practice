...
## 1. 基本的なカーソル (OPEN / FETCH / CLOSE)

**ファイル:** `sql/4-cursor/1-basic-cursor.sql`
...
**ファイル:** `sql/4-cursor/2-parameterized.sql`
...
## 3. FOR ループによるカーソルの簡略化

**ファイル:** `sql/4-cursor/3-for-cursor.sql`
...
**ファイル:** `sql/4-cursor/4-batch-processing.sql`
...
## 5. UPDATE WHERE CURRENT OF

**ファイル:** `sql/4-cursor/5-update-current-of.sql`
...
**ファイル:** `sql/4-cursor/6-scroll-cursor.sql`
...
← [前へ: ループ](4-loop.md) | [BASIC_CONTROL](README.md) | [次へ: 例外処理](6-exception.md) →
