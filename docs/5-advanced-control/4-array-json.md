...
**ファイル:** `sql/4-array-json/1-array-basics.sql`
...
**ファイル:** `sql/4-array-json/2-foreach.sql`
...
**ファイル:** `sql/4-array-json/3-array-agg.sql`
...
**ファイル:** `sql/4-array-json/4-any-all.sql`
...
**ファイル:** `sql/4-array-json/5-array-operations.sql`
...
**ファイル:** `sql/4-array-json/6-json-basics.sql`
...
## 7. row_to_json でレコードを JSON に変換

**ファイル:** `sql/4-array-json/7-row-to-json.sql`
...
## 8. jsonb_agg で集約結果を JSON 配列にする

**ファイル:** `sql/4-array-json/8-jsonb-agg.sql`
...
## 9. jsonb_each でキーと値をループ

**ファイル:** `sql/4-array-json/9-jsonb-each.sql`
...
**ファイル:** `sql/4-array-json/10-jsonb-operators.sql`
...
← [前へ: 動的 SQL (EXECUTE)](3-dynamic-sql.md) | [ADVANCED_CONTROL](README.md) | [次へ: CTE (WITH 句) とウィンドウ関数](5-cte-window.md) →
