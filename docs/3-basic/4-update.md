...
**ファイル:** `sql/3-update/1-simple-update.sql`
...
**ファイル:** `sql/3-update/2-multi-column.sql`
...
**ファイル:** `sql/3-update/3-conditional.sql`
...
**ファイル:** `sql/3-update/4-multi-row.sql`
...
## 5. CASE を使った条件付き UPDATE

**ファイル:** `sql/3-update/5-case-update.sql`
...
**ファイル:** `sql/3-update/6-subquery.sql`
...
**ファイル:** `sql/3-update/7-from-update.sql`
...
**ファイル:** `sql/3-update/8-returning.sql`
...
← [前へ: INSERT](3-insert.md) | [BASIC](README.md) | [次へ: DELETE](5-delete.md) →
